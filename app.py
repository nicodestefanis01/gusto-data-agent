...
TABLE_SCHEMAS = {
    ...
    "zenpayroll_production_no_pii.customer_risk_tiers": ['uuid', 'combined_risk_tier', 'fraud_risk_tier', 'credit_risk_tier', 'company_id', 'tier_date', 'id', 'created_at', 'updated_at', '__op', '__ts_ms', '__source_ts_ms', '__source_file', '__source_pos', '_airflow_ti_id', '_etl_tstamp'],
    "zenpayroll_production_no_pii.onboarding_risk_scores": ['company_id', 'score', 'threshold', 'model_version', 'id', 'created_at', 'updated_at', '__op', '__ts_ms', '__source_ts_ms', '__source_file', '__source_pos', '_airflow_ti_id', '_etl_tstamp'],
    "bi.risk_onboarding": ['company_id', 'joined_at', 'company_created_at', 'sales_program', 'first_product_plan', 'initial_company_size', 'user_provided_industry', 'current_company_size', 'is_mrb', 'is_gep_company', 'gep_partner_name', 'originally_finished_onboarding_at', 'first_approved_at', 'last_rejected_at', 'approval_status', 'is_active', 'risk_state', 'risk_state_description', 'is_fraud', 'suspension_at', 'updated_at', 'first_rfi_id', 'only_risk_blocked', 'auto_approved', 'approved_by_system', 'risk_auto_approved', 'flagged_by_compliance', 'customer_type', 'first_rfi_situation', 'number_of_rfis', 'number_of_rfi_fraud_requests', 'number_of_rfi_nonprofit_fraud_requests', 'number_of_rfi_soleprop_fraud_requests', 'number_of_fein_mismatch_requests', 'number_of_other_compliance_requests', 'first_rejected_at', 'risk_rfi_data_flag', 'first_rfi_at', 'flagged', 'review_status', 'dbt_incremental_ts', 'etl_insert_ts', 'etl_update_ts', 'onboarded_via_mobile_app', 'onboarding_event_platform'],
    "zenpayroll_production_no_pii.risk_onboarding_ai_agent_decisions": ['uuid', 'company_id', 'decision', 'status', 'trust_analyst_decision', 'trust_analyst_confidence', 'risk_analyst_decision', 'risk_analyst_confidence', 'version', 'id', 'created_at', 'updated_at', '__op', '__ts_ms', '__source_ts_ms', '__source_file', '__source_pos', '_airflow_ti_id', '_etl_tstamp'],
    "zenpayroll_production_no_pii.cached_payroll_blockers": ['tx_start', 'tx_end', 'company_id', 'reason', 'id', 'created_at', 'updated_at', '__op', '__ts_ms', '__source_ts_ms', '__source_file', '__source_pos', '_airflow_ti_id', '_etl_tstamp'],
    "bi.company_approval_details": ['id', 'company_id', 'approved_by_id', 'approved_by_system', 'first_approved_at', 'last_rejected_at', 'approval_status', 'ready_for_approval', 'risk_state', 'risk_state_description', 'only_expeditable_by_risk', 'initial_auto_approval_blockers', 'auto_approval_blockers', 'created_at', 'updated_at', 'current_flag', 'dbt_incremental_ts', 'etl_insert_ts', 'etl_update_ts']
}
